 ...
 */
package org.lucid.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_DEVICE_MODEL = "ro.product.vendor.model";
    public static final String PROP_DEVICE_NAME = "ro.product.device";
